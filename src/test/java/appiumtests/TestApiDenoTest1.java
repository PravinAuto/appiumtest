...
public class TestApiDenoTest1 {

	
	public static AndroidDriver driver;
	public static void test(String mobile,int timeframe) throws MalformedURLException , InterruptedException{
  ...
  //  cap.setCapability(AndroidMobileCapabilityType.APP_ACTIVITY, ".ApiDemos");
    ...
    System.out.println("is insan ke sath prank hone wala hai wait for ");
    System.out.println("------------------------"
    		+ "-------------------------"
    		+ "----------------------");
  /*  
